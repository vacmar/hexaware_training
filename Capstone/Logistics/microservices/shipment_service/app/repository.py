...
class ShipmentRepository:
    ...
    def get_by_hub(self, hub_id: UUID) -> List[Shipment]:
        """Get all shipments at a specific hub"""
        return self.db.query(Shipment).filter(Shipment.current_hub_id == hub_id).all()
